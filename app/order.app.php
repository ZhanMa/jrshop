...
class OrderApp extends ShoppingbaseApp
{
    ...
    function index()
    {
        ...
        $msg = '【96018】尊敬的金融街用户，您所购买的'. implode(',',$goods_names).',订单号：'.$order['order_sn'].',商品券密码为'.$msg_code.'。无需预约。持本券到商家进行认证即可【96018金融街生活在线】';
        ...
        $this->show_message('您的短信已成功发送，请注意 查收','buyer_order','index.php?app=buyer_order&act=view&order_id=' . $order_id);
        return;
