...
class TemplateApp extends BackendApp
{
    ...
    function _get_editable_pages()
    {
		...
		$data['cart'] 		= array('title'=>LANG::get('cart'),'url'=> $real_site_url . '/index.php?app=cart', 'action'=>array());
		$data['article'] 	= array('title'=>LANG::get('article'),'url'=> $real_site_url . '/index.php?app=article', 'action'=>array());
		$data['search'] 	= array('title'=>LANG::get('search'),'url'=> $real_site_url . '/index.php?app=search', 'action'=>array());
		$data['searchstore'] 	= array('title'=>LANG::get('searchstore'),'url'=> $real_site_url . '/index.php?app=search&act=store', 'action'=>array());
		$data['groupbuy'] 	= array('title'=>LANG::get('groupbuy'),'url'=> $real_site_url . '/index.php?app=search&act=groupbuy', 'action'=>array());
		$data['brand'] 	= array('title'=>'品牌墙','url'=> $real_site_url . '/index.php?app=/index.php?app=brand', 'action'=>array());
		$data['storelist'] 	= array('title'=>'店铺墙','url'=> $real_site_url . '/index.php?app=/index.php?app=storelist', 'action'=>array());
