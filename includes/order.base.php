...
//     	$y = date('y', $timestamp);
//     	$z = date('z', $timestamp);
//     	$msg_code = $y . str_pad(mt_rand(1, 99), 2, '0', STR_PAD_LEFT). str_pad($z, 4, '0', STR_PAD_LEFT) . str_pad(mt_rand(1, 9999), 4, '0', STR_PAD_LEFT) . str_pad(mt_rand(1, 9999), 4, '0', STR_PAD_LEFT);

//     	$ordergoods =& m('ordergoods');
//     	$goods = $ordergoods->find('msg_code=' . $msg_code);
//     	if (empty($goods))
//     	{
//     		/* 否则就使用这个订单号 */
//     		return $msg_code;
