 ...
 */
class Jrj_newgoods_2Widget extends BaseWidget
{
    var $_name = 'jrj_newgoods_2';
	var $_ttl  = 1800;
    var $_num  = 5;
    ...
    function _get_data()
    {
        ...
        if($data === false)
        {
			...
			$store_mod=&m('store');
			$stores=$store_mod->find(array("conditions" => 'state = 1 AND cate_id ='.$this->options['store_cate_id'],'join'  => 'has_scategory','order'=>'add_time desc','limit'=>14));
