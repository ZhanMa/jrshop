 ...
 * @return  array
 */
class Tcz_search_goods_list_2Widget extends BaseWidget
{
    var $_name = 'tcz_search_goods_list_2';
    var $_ttl  = 1800;
    ...
    function _get_data()
    {
        ...
        if($data === false)
        {
			...
			foreach($goods_list as $k=>$v){
				...
				$goods_mod=&m('goods');
				$goods=$goods_mod->get(array('conditions'=>'goods_id='.$v['goods_id'],'fields'=>'market_price'));
				$goods_list[$k]['market_price']=$goods['market_price'];
			}
